...
## Key Screenshots
- ![Windows EC2 Launch](./screenshots/ec2-p1/windows-launch.png)
- ![Linux EC2 Launch](./screenshots/ec2-p1/linux-launch.png)
- ![PuTTYGen Conversion](./screenshots/ec2-p1/puttygen.png)
- ![PuTTY Connection](./screenshots/ec2-p1/putty-connect.png)
- ![MobaXterm Connection](./screenshots/ec2-p1/mobaxterm.png)
- ![Elastic IP Assignment](./screenshots/ec2-p1/eip-assign.png)
- ![Launch Template](./screenshots/ec2-p1/launch-template.png)
- ![Shutdown Behaviour](./screenshots/ec2-p1/shutdown.png)
- ![EC2 Dashboard](./screenshots/ec2-p1/dashboard.png)
