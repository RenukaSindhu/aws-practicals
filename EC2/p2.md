...
2. Launched Linux EC2 instance:
   ...
   - Copied image to another region (Ireland).
   - Deregistered image in Ireland after verification.
...
## Key Screenshots
- ![Windows AMI Creation](./screenshots/ec2-p2/windows-ami.png)
- ![Windows AMI Launch](./screenshots/ec2-p2/windows-ami-launch.png)
- ![Linux AMI Creation](./screenshots/ec2-p2/linux-ami.png)
- ![AMI Copy to Ireland](./screenshots/ec2-p2/ami-copy-ireland.png)
- ![Encrypted AMI](./screenshots/ec2-p2/encrypted-ami.png)
- ![Snapshot Creation](./screenshots/ec2-p2/snapshot-create.png)
- ![Snapshot Copy](./screenshots/ec2-p2/snapshot-copy.png)
- ![Snapshot Share](./screenshots/ec2-p2/snapshot-share.png)
- ![AMI from Snapshot](./screenshots/ec2-p2/ami-from-snapshot.png)
- ![Recycle Bin](./screenshots/ec2-p2/recyclebin.png)
