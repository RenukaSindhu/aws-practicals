...
## Steps Performed
1. Cross Task:
   - Moved volumes across Availability Zones using snapshots (refer to diagram).
...
## Key Screenshots
- ![Cross Task Diagram](./screenshots/ec2-p3/cross-task.png)
- ![Root Volume Resize](./screenshots/ec2-p3/root-resize.png)
- ![Additional Volume](./screenshots/ec2-p3/additional-volume.png)
- ![Attach/Detach Root](./screenshots/ec2-p3/attach-detach-root.png)
- ![Attach as Additional](./screenshots/ec2-p3/attach-detach-additional.png)
- ![Life Cycle Policy](./screenshots/ec2-p3/lifecycle-policy.png)
- ![Snapshots](./screenshots/ec2-p3/snapshots.png)
- ![EC2 Termination](./screenshots/ec2-p3/termination.png)
